...
<div class="topnav">
    <div class="topnav_bd w1210 bc">
        <div class="topnav_left">
            ...
            <?php
            $member=Yii::$app->user->identity?Yii::$app->user->identity->username:'';
            ?>
        </div>
        <div class="topnav_right fr">
            <ul>
                <li>您好<?=$member?>，欢迎来到京西！<?php if($member){echo '[<a href="http://www.yiishop.com/member/loginout.html">注销</a>]';}else{echo '[<a href="http://www.yiishop.com/member/login.html">登录</a>]';};?>[<a href="register.html">免费注册</a>] </li>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
                <li>客户服务</li>
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd">
                ...
                <?php foreach ($categorys1 as $i=>$category1):?>
                <div class="cat <?=$i?'':'item1'?>">
                    <h3><a href="<?=\yii\helpers\Url::to(['shop/list','category_id'=>$category1->id])?>"><?=$category1->name?></a><b></b></h3>
                    <div class="cat_detail">
                        <?php foreach ($category1->children(1)->all() as $k=>$category2):?>
                        <dl <?=$k?'':'class="dl_1st"'?>>
                            <dt><a href="<?=\yii\helpers\Url::to(['shop/list','category_id'=>$category2->id])?>"><?=$category2->name?></a></dt>
                            <?php foreach ($category2->children()->all() as $category3):?>
                            <dd>
                                <a href="<?=\yii\helpers\Url::to(['shop/list','category_id'=>$category3->id])?>"><?=$category3->name?></a>
                            </dd>
                                <?php endforeach;?>
                        </dl>
                        <?php endforeach;?>
