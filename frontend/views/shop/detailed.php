    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=$good->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img   style="width:350px" src="<?=$good->logo?>" alt="" />               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            <li>
                                <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://admin.yiishop.com<?=$img->path?>',largeimage: 'http://admin.yiishop.com<?=$img->path?>'}"><img src="http://admin.yiishop.com<?=$img->path?>"></a>
                            </li>
                            <?php endforeach;?>
                        </ul>
                    </div>
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action="<?=\yii\helpers\Url::to(['cart/addtocarts'])?>" method="get" class="choose">
                    <ul>
