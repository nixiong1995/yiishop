...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        ...
        <div class="address_hd">
            ...
            <dl data_id="<?=$model->id?>">
                <dt><?php echo $i++;?>&nbsp;<?php echo $model->name?>&nbsp;<?php echo $model->province?>
                    &nbsp;<?php echo $model->city?>&nbsp;<?php echo $model->address?>&nbsp;<?php echo $model->phone?> </dt>
                <dd>
                    <a href="<?=\yii\helpers\Url::to(['locations/edit','id'=>$model->id])?>">修改</a>
        ...
        <div class="address_bd mt10">
            <h4>新增收货地址</h4>
            <form action="<?=\yii\helpers\Url::to(['locations/address'])?>" method="post" name="address_form">
                <ul>
                    <li>
...
<script type="text/javascript">
    $('#delete').on('click',function () {
        ...
        var id=dl.attr('data_id');
        if(confirm('你确定要删除吗?')){
            $.get("<?=\yii\helpers\Url::to(['locations/del'])?>",{id:id},function (data) {
                if(data=='success'){
                    alert('删除成功');
                    dl.hide('slow');
                }else {
